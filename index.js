...
async function run() {
  ...
  console.log(findUser?.role)
    ...
    const data = {
      ...
      success_url: `https://taqwaa-services-v2-servers.vercel.app/payment/success/${trans_id}`,
      fail_url: `https://taqwaa-services-v2-servers.vercel.app/payment/failed/${trans_id}`,
      cancel_url: 'https://taqwaa-services-v2-servers.vercel.app/cancel',
      ipn_url: 'https://taqwaa-services-v2-servers.vercel.app/ipn',
